  ...
  return (
    <div className="Middle">
      ...
      <div className="MidDash">
        <div className="DashHeader my-2">
          <h3>Dashboard</h3>
          <button className="btn float-right settle my-2" onClick={props.settle}>
            Settle up
          </button>
          <button className="btn float-right expense my-2" onClick={props.friend}>
            Add an expense
          </button>
        </div>
      ...
      <div className="totalCollection">
        ...
        <div>
          <label htmlFor="" className="float-right mr-5 owewindow" >
            You are owed
          </label>
        </div>
      </div>
