           ...
           <Header/>
            <main >
                <div className = "landing-heading">
                 ...
                 {/* <img align="middle" className = "landing-logo" src={require('../images/1.png')} alt=""/>    */}
                <h1 className = "landing-header"> <span className="word-style-1">Split</span> expenses with friends.</h1>
